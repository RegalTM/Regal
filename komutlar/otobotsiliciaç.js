...
exports.run = (client, message, args) => { 
  ...
  message.reply(`**Sadece bu sohbet kanalında** tüm botların mesajlarını bot mesaj Mediatıktan **2 dakika** sonra sileceğim şu anda bu özellik aktif. ${client.emojis.get("647746144155467786")}

...
Örnek: \`!rol-otomMediaik-silinecek-ayarla komutismi @rol\`
...
Örnek: \`!rol-otomMediaik-silenicek-ayarla ${args[0]} @rol\`
...
module.exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['rolotomMediaiksilinicekayarla'],
  permLevel: 0
};

module.exports.help = {
  name: 'rol-otomMediaik-silinecek-ayarla',
  description: '',
  usage: ''
};
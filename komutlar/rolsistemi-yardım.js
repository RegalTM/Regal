...
Bir Üye Diğer Bir Üyeye Rol Verirse Hangi Kanala Log Tutsun.`)
     ...
     .addField(`• \`!rol-otomMediaik-silinecek-ayarla komutunuz @rol\`》`, `Belirlenen Rol Verildikten Sonra Silinmesini İstediğiniz Bir Rol Var İse Onu Siler
Örnek Örnek Kayıtlı Üyeyi Vermeye Ayarlayıp OtomMediaik Silinecek Kısmınada Kayıtsız Üye Rolünü Ayarlarsınız.

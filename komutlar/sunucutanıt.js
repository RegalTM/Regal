...
exports.run = async (client, message, args) => {
  ...
  .setAuthor('PONET - Media BOT', client.user.avMediaarURL)
  .setTitle('PONET - Media BOT', client.user.avMediaarURL)
 ...
 message.channel.sendEmbed(embed);
    message.channel.creMediaeInvite({maxAge: 0}).then((invite) => {
        const embed = new Discord.RichEmbed()
      .setAuthor('PONET - Media BOT', client.user.avMediaarURL)
      .setTitle('PONET - Media', client.user.avMediaarURL)
      .setURL("https://discord.gg/YyfNEf8")
  ...
  {
  message.reply("Bu özelliği `(24)` SaMedia içinde yalnızca 1 kez kullanabilirsiniz")
  }
};

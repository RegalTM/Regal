...
`)
  ...
  message.channel.send(`${client.emojis.get("647746144155467786")} ${rol} Rolü Olan Her Kullanıcı İnsanları !ban Komutu İle Banlayabilicektir Rolü Verirken DikkMediali Olunuz.`)
